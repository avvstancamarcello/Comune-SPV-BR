...
const styles = StyleSheet.create({
  ...
  modal:{flex:1,backgroundColor:"#f3f8f5"},modalHeader:{backgroundColor:"#fff",borderBottomWidth:1,borderBottomColor:"#d6e2db"},back:{minHeight:54,paddingHorizontal:16,flexDirection:"row",alignItems:"center"},backText:{marginLeft:9,color:"#176b51",fontSize:16,fontWeight:"700"},detail:{padding:16,paddingBottom:40},hero:{width:"100%",height:230,borderRadius:16,backgroundColor:"#d8e6dd"},detailTitle:{marginTop:18,fontSize:27,fontWeight:"700",color:"#176b51"},detailText:{marginTop:13,fontSize:17,lineHeight:27,color:"#283b34"},note:{marginTop:18,padding:14,borderRadius:10,backgroundColor:"#fff3cd",fontSize:14,lineHeight:21,color:"#594b1f"}
});
